...
if thermal == True:
    plt.title("Tetragonal, 300 K", fontsize=10)
else:
    plt.title("Tetragonal, 0 K", fontsize=10)
...
plt.tight_layout()
if thermal == True:
    plt.savefig('Tetragonal_300K.png', dpi=300)
else:
    plt.savefig('Tetragonal_0K.png', dpi=300)
