...
if thermal == True:
    plt.title("Cubic, 300 K", fontsize=10)
else:
    plt.title("Cubic, 0 K", fontsize=10)
...
plt.tight_layout()
if thermal == True:
    plt.savefig('Cubic_300K.png', dpi=300)
else:
    plt.savefig('Cubic_0K.png', dpi=300)
